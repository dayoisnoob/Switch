CREATE TYPE "public"."notification_type" AS ENUM('card_assigned', 'card_unassigned', 'card_due_soon', 'comment_added', 'mentioned');--> statement-breakpoint
...
CREATE INDEX "wm_user_id_idx" ON "workspace_memberships" USING btree ("user_id");