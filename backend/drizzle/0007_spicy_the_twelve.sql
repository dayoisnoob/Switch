ALTER TABLE "task_assignees" RENAME TO "card_assignees";--> statement-breakpoint
ALTER TABLE "tasks" RENAME TO "cards";--> statement-breakpoint
ALTER TABLE "card_assignees" DROP CONSTRAINT "task_assignees_card_id_tasks_id_fk";
--> statement-breakpoint
ALTER TABLE "card_assignees" DROP CONSTRAINT "task_assignees_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "cards" DROP CONSTRAINT "tasks_column_id_columns_id_fk";
--> statement-breakpoint
ALTER TABLE "cards" DROP CONSTRAINT "tasks_board_id_boards_id_fk";
--> statement-breakpoint
ALTER TABLE "cards" DROP CONSTRAINT "tasks_created_by_users_id_fk";
--> statement-breakpoint
ALTER TABLE "card_labels" DROP CONSTRAINT "card_labels_card_id_tasks_id_fk";
--> statement-breakpoint
ALTER TABLE "comments" DROP CONSTRAINT "comments_card_id_tasks_id_fk";
--> statement-breakpoint
ALTER TABLE "attachments" DROP CONSTRAINT "attachments_card_id_tasks_id_fk";
--> statement-breakpoint
ALTER TABLE "activities" DROP CONSTRAINT "activities_card_id_tasks_id_fk";
--> statement-breakpoint
...
ALTER TABLE "activities" ADD CONSTRAINT "activities_card_id_cards_id_fk" FOREIGN KEY ("card_id") REFERENCES "public"."cards"("id") ON DELETE cascade ON UPDATE no action;